"""
Django settings for personal_budgeting_api project.
...
SECRET_KEY = config('SECRET_KEY', default='django-insecure-y!t@5hbqj9^abrdqm@5k@e@%g^&wk_p)51!ob@xz#ng%rpdd89')
...
ROOT_URLCONF = 'personal_budgeting_api.urls'
...
WSGI_APPLICATION = 'personal_budgeting_api.wsgi.application'
